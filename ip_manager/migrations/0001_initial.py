# Generated by Django 2.2.4 on 2022-04-09 10:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_enable', models.BooleanField(default=True, verbose_name='expire time')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='create time')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='update time')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ip_manager.SourcePool', verbose_name='isp')),
            ],
            options={
